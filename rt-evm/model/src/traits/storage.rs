...
pub trait TxStorage {
    fn insert_btc_txs(&self, block_height: u64, btc_txs: Vec<Transaction>) -> Result<()>;

    fn insert_txs(&self, block_height: u64, signed_txs: Vec<SignedTransaction>) -> Result<()>;
    ...
    fn get_txs(&self, block_height: u64, hashes: &[Hash])
    ...
    fn get_receipts(&self, block_height: u64, hashes: &[Hash]) -> Result<Vec<Option<Receipt>>>;
}
